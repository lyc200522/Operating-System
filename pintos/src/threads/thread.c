...
{
  return FP_MULN(FP_ROUND(load_avg),100);
}
...
{
  return FP_MULN(FP_ROUND(thread_current()->recent_cpu),100);
}
...
void thread_update_load_avg(void){
    ...
    load_avg=FP_ADD(FP_DIVN(FP_MULN(load_avg,59),60),FP_DIVN(FP_FP(size),60));
}
